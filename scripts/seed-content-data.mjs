// AUTO-GENERATED shared seed data for NodalQuest.
// Consumed by scripts/seed-content.mjs (local runner) and server/_core/setup.ts (in-app setup endpoint).
// Regenerate lessons/quizzes from scripts/seed-content.mjs if their content changes.

export const ZONES = [
  { slug: "nws-hub",             name: "Nodal Hub",            description: "Token & ecosystem basics — learn what $NODAL is and how it powers NodalWaves.", order: 1, requiredLevel: 1,  requiredXp: 0,   icon: "Coins",     color: "#FFB000" },
  { slug: "staking-vault",       name: "Staking Vault",        description: "Responsible staking — how locking $NODAL supports the ecosystem and earns rewards.", order: 2, requiredLevel: 2,  requiredXp: 0,   icon: "Vault",     color: "#B30000" },
  { slug: "lite-node-station",   name: "Lite Node Station",    description: "The entry-level node tier — an accessible way to help run the network.", order: 3, requiredLevel: 3,  requiredXp: 0,   icon: "Cpu",       color: "#3182CE" },
  { slug: "founder-tower",       name: "Founder Tower",        description: "Higher-tier Founder Nodes and the responsibility that comes with them.", order: 4, requiredLevel: 5,  requiredXp: 0,   icon: "Building2", color: "#805AD5" },
  { slug: "node-vault-chamber",  name: "Node Vault Chamber",   description: "Node-linked vaults — combining staking and node operation for deeper participation.", order: 5, requiredLevel: 7,  requiredXp: 0,   icon: "Lock",      color: "#D69E2E" },
  { slug: "treasury-hall",       name: "Treasury Hall",        description: "Treasury alignment and how community activity supports long-term growth.", order: 6, requiredLevel: 9,  requiredXp: 0,   icon: "Landmark",  color: "#38A169" },
  { slug: "security-lab",        name: "Security Lab",         description: "Wallet safety and scam protection — the skills that keep you safe in Web3.", order: 7, requiredLevel: 11, requiredXp: 0,   icon: "Shield",    color: "#E53E3E" },
  { slug: "community-arena",     name: "Community Arena",      description: "How the NodalWaves community is organised and how to contribute.", order: 8, requiredLevel: 13, requiredXp: 0,   icon: "Users",     color: "#DD6B20" },
  { slug: "future-utility-zone", name: "Future Utility Zone",  description: "The roadmap — upcoming features, integrations, and utility for $NODAL.", order: 9, requiredLevel: 15, requiredXp: 0,   icon: "Rocket",    color: "#00B5D8" },
];

export const BADGES = [
  { slug: "first-steps",        name: "First Steps",        description: "Complete your first lesson.",                     icon: "Footprints", color: "#FFB000", criteria: { type: "lesson", value: 1 },   xpBonus: 25 },
  { slug: "knowledge-seeker",   name: "Knowledge Seeker",   description: "Complete 3 lessons.",                             icon: "BookOpen",   color: "#FFB000", criteria: { type: "lesson", value: 3 },   xpBonus: 50 },
  { slug: "scholar",            name: "Scholar",            description: "Complete 6 lessons.",                             icon: "GraduationCap", color: "#FFB000", criteria: { type: "lesson", value: 6 }, xpBonus: 75 },
  { slug: "quiz-master",        name: "Quiz Master",        description: "Score 100% on any quiz.",                         icon: "Award",      color: "#B30000", criteria: { type: "quiz_perfect", value: 1 }, xpBonus: 50 },
  { slug: "rising-star",        name: "Rising Star",        description: "Reach level 5.",                                  icon: "Star",       color: "#FFB000", criteria: { type: "level", value: 5 },    xpBonus: 50 },
  { slug: "veteran",            name: "Veteran",            description: "Reach level 10.",                                 icon: "Medal",      color: "#C0C0C0", criteria: { type: "level", value: 10 },   xpBonus: 100 },
  { slug: "legend",             name: "Legend",             description: "Reach level 25.",                                 icon: "Crown",      color: "#B30000", criteria: { type: "level", value: 25 },   xpBonus: 250 },
  { slug: "streak-starter",     name: "Streak Starter",     description: "Maintain a 3-day check-in streak.",               icon: "Flame",      color: "#DD6B20", criteria: { type: "streak", value: 3 },   xpBonus: 30 },
  { slug: "streak-keeper",      name: "Streak Keeper",      description: "Maintain a 7-day check-in streak.",               icon: "Flame",      color: "#E53E3E", criteria: { type: "streak", value: 7 },   xpBonus: 70 },
  { slug: "streak-master",      name: "Streak Master",      description: "Maintain a 30-day check-in streak.",              icon: "Flame",      color: "#B30000", criteria: { type: "streak", value: 30 },  xpBonus: 300 },
  { slug: "xp-1k",              name: "XP Collector",       description: "Earn 1,000 total XP.",                            icon: "Zap",        color: "#FFB000", criteria: { type: "xp", value: 1000 },    xpBonus: 50 },
  { slug: "xp-5k",              name: "XP Champion",        description: "Earn 5,000 total XP.",                            icon: "Trophy",     color: "#FFB000", criteria: { type: "xp", value: 5000 },    xpBonus: 150 },
  { slug: "node-charger",       name: "Node Charger",       description: "Play the Node Charge mini-game.",                 icon: "Zap",        color: "#38A169", criteria: { type: "mini_game", value: "node_charge" },   xpBonus: 25 },
  { slug: "quiz-brawler",       name: "Quiz Brawler",       description: "Play the Timed Quiz Battle mini-game.",           icon: "Target",     color: "#3182CE", criteria: { type: "mini_game", value: "quiz_battle" },   xpBonus: 25 },
  { slug: "scam-buster",        name: "Scam Buster",        description: "Play the Scam Detector mini-game.",               icon: "Shield",     color: "#E53E3E", criteria: { type: "mini_game", value: "scam_detector" }, xpBonus: 25 },
  { slug: "community-educator",  name: "Community Educator", description: "Refer your first community member.",              icon: "Users",      color: "#805AD5", criteria: { type: "referral", value: 1 }, xpBonus: 100 },
];

export const ANNOUNCEMENTS = [
  { title: "Welcome to NodalQuest — Season 01 is live", content: "Learn the NodalWaves ecosystem, complete quests and quizzes, earn XP, and climb the leaderboard. XP, badges, and ranks are learning achievements, not financial rewards.", type: "campaign", isActive: true, ctaText: "Start learning", ctaLink: "/dashboard" },
];

export const LESSONS = [
  // Zone 1: Nodal Hub
  { zoneSlug: "nws-hub", title: "What is Nodal Token?", topic: "nws", content: `# What is Nodal Token?
...
> **Remember:** $NODAL is a utility token. Its value is tied to ecosystem adoption and usage, not guaranteed returns. Always do your own research before participating.`, xpReward: 50, order: 1 },
  ...
  { zoneSlug: "nws-hub", title: "$NODAL Tokenomics Explained", topic: "nws", content: `# $NODAL Tokenomics Explained
...
> **Important:** Tokenomics can change as the ecosystem evolves. Always refer to the latest official NodalWaves documentation for current figures.`, xpReward: 60, order: 2 },
  ...
  { zoneSlug: "staking-vault", title: "What is Staking?", topic: "staking", content: `# What is Staking?
...
> **Always understand the risks before staking. Never stake more than you can afford to lock up.**`, xpReward: 60, order: 1 },
  ...
  { zoneSlug: "staking-vault", title: "General Staking in NodalWaves", topic: "staking", content: `# General Staking in NodalWaves
...
> **Staking is not a savings account. It is ecosystem participation with associated risks.**`, xpReward: 70, order: 2 },
  ...
  { zoneSlug: "lite-node-station", title: "What is a Lite Node?", topic: "lite_node", content: `# What is a Lite Node?
...
> **Note:** Lite Node rewards are variable and not guaranteed. They depend on network activity, total node count, and ecosystem health.`, xpReward: 70, order: 1 },
  ...
  { zoneSlug: "founder-tower", title: "What is a Founder Node?", topic: "founder_node", content: `# What is a Founder Node?
...
> **Founder Node participation is a long-term ecosystem commitment, not a short-term investment.**`, xpReward: 80, order: 1 },
  ...
  { zoneSlug: "node-vault-chamber", title: "What is Node Vault?", topic: "node_vault", content: `# What is Node Vault / Node-Linked Vault?
...
> **The Node Vault is an advanced feature. Fully understand all mechanics and risks before participating.**`, xpReward: 80, order: 1 },
  ...
  { zoneSlug: "treasury-hall", title: "What is the NodalWaves Treasury?", topic: "treasury", content: `# What is the NodalWaves Treasury?
...
> **Note:** Exact treasury wallet addresses, multisig configurations, and governance mechanisms should be verified through official NodalWaves documentation.**`, xpReward: 75, order: 1 },
  ...
  // Zone 7: Security Lab
  { zoneSlug: "security-lab", title: "Wallet Safety Fundamentals", topic: "wallet_safety", content: `# Wallet Safety Fundamentals
...
> **Remember: In Web3, you are your own bank. There is no customer support to recover lost funds.**`, xpReward: 80, order: 1 },
  ...
  { zoneSlug: "security-lab", title: "Scam Protection Guide", topic: "scam_protection", content: `# Scam Protection Guide
...
> **The best scam protection is education. You are already taking the right step by learning.**`, xpReward: 90, order: 2 },
  ...
  { zoneSlug: "community-arena", title: "NodalWaves Community Structure", topic: "nws", content: `# NodalWaves Community Structure
...
> **The strongest ecosystems are built by educated, engaged communities. Your participation matters.**`, xpReward: 65, order: 1 },
  ...
  { zoneSlug: "future-utility-zone", title: "Future Utility Layer", topic: "nws", content: `# Future Utility Layer
