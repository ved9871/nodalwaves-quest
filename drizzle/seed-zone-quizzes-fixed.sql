...
(3, 'Lite Node Basics', 'Learn about Lite Node participation in the NodalWaves ecosystem', 120, 100, 70);
...
INSERT INTO quizzes (zoneId, title, description, timeLimitSeconds, xpReward, passingScore) VALUES 
(6, 'Treasury and Ecosystem Growth', 'Understand how the NodalWaves treasury supports ecosystem development', 120, 100, 70);
...
INSERT INTO quizzes (zoneId, title, description, timeLimitSeconds, xpReward, passingScore) VALUES 
(8, 'Community Learning and Competition', 'Engage with the NodalWaves community through education and skill-based challenges', 120, 100, 70);
