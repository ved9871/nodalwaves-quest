...
VALUES (3, 'Lite Node Basics Quiz', 'Test your understanding of Lite Nodes in the NodeWaves ecosystem.', 120, 50, 60);

SET @q3 = LAST_INSERT_ID();

INSERT INTO quiz_questions (quizId, question, options, correctIndex, explanation, `order`) VALUES
(@q3, 'What is a Lite Node in the NodeWaves ecosystem?',
 '["A type of bank account","A lightweight network participant that helps support the NodeWaves ecosystem","A guaranteed income product","A social media profile"]',
 1, 'A Lite Node is a lightweight participant role in the NodeWaves ecosystem. It is designed to support network activity, not to function as a financial product or guaranteed income source.', 1),
...
INSERT INTO quizzes (zoneId, title, description, timeLimitSeconds, xpReward, passingScore)
VALUES (4, 'Founder Node Knowledge Quiz', 'Learn what Founder Nodes represent in the NodeWaves ecosystem.', 120, 50, 60);

SET @q4 = LAST_INSERT_ID();

INSERT INTO quiz_questions (quizId, question, options, correctIndex, explanation, `order`) VALUES
(@q4, 'What is the primary role of a Founder Node in the NodeWaves ecosystem?',
 ...
 1, 'Founder Nodes represent a higher-tier participation role in the NodeWaves ecosystem. They are designed to support ecosystem growth, not to guarantee income or replace financial institutions.', 1),

(@q4, 'How are Founder Node purchases typically aligned in the NodeWaves ecosystem?',
 ...
 1, 'NodeWaves is designed as a community-first ecosystem. Node-related activity is aligned with supporting the ecosystem treasury and long-term sustainability, not personal enrichment of the founding team.', 2),
...
INSERT INTO quiz_questions (quizId, question, options, correctIndex, explanation, `order`) VALUES
(@q5, 'What is a Node Vault (or Node-Linked Vault) in the NodeWaves ecosystem?',
 ...
 1, 'A Node Vault is an ecosystem feature linked to node participation in NodeWaves. It is not a bank product, not government-regulated, and does not guarantee fixed returns.', 1),
...
INSERT INTO quizzes (zoneId, title, description, timeLimitSeconds, xpReward, passingScore)
VALUES (6, 'Treasury & Ecosystem Quiz', 'Learn how the NodeWaves treasury supports long-term ecosystem health.', 120, 50, 60);

SET @q6 = LAST_INSERT_ID();

INSERT INTO quiz_questions (quizId, question, options, correctIndex, explanation, `order`) VALUES
(@q6, 'What is the purpose of an ecosystem treasury in a Web3 project like NodeWaves?',
...
INSERT INTO quizzes (zoneId, title, description, timeLimitSeconds, xpReward, passingScore)
VALUES (8, 'Community & Education Quiz', 'Explore the role of community education in the NodeWaves ecosystem.', 120, 50, 60);

SET @q8 = LAST_INSERT_ID();

INSERT INTO quiz_questions (quizId, question, options, correctIndex, explanation, `order`) VALUES
(@q8, 'Why is community education important in a Web3 ecosystem like NodeWaves?',
...
(@q8, 'What is the best way to contribute to the NodeWaves community?',
...
(@q8, 'What does the NodeWaves Quest platform reward users for?',
 ...
 1, 'NodeWaves Quest rewards learning, quest completion, XP accumulation, and leaderboard performance. It is an educational platform — not a guaranteed earning or income program.', 3);

-- ── Zone 9: Future Utility Zone ───────────────────────────────────────────────
INSERT INTO quizzes (zoneId, title, description, timeLimitSeconds, xpReward, passingScore)
VALUES (9, 'Future Utility & Web3 Quiz', 'Explore the future utility layer and broader Web3 concepts in NodeWaves.', 120, 50, 60);

SET @q9 = LAST_INSERT_ID();

INSERT INTO quiz_questions (quizId, question, options, correctIndex, explanation, `order`) VALUES
(@q9, 'What does "utility" mean in the context of a Web3 token like NWS?',
...
(@q9, 'What is the NodeWaves ecosystem\'s long-term vision?',
 ...
 1, 'NodeWaves\' long-term vision is to build a community-first ecosystem focused on education, responsible utility, and sustainable growth — not to promise wealth or replace traditional finance overnight.', 3);
