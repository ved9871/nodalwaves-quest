      ...
      <nav className="sticky top-0 z-40 glass border-b border-border">
        <div className="container flex items-center justify-between h-16">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-display font-black text-sm text-foreground">NodalQuest</div>
      ...
      <div className="container py-8 max-w-5xl mx-auto space-y-8">
        ...
        <div className="rounded-xl border border-border/50 bg-muted/10 p-4 text-center space-y-1">
          <p className="text-xs text-muted-foreground">
            NodalQuest Beta Review — Read-only. All funnel counts are <strong>distinct users</strong>.
