...
const LESSON_CONTENT: Record<string, {
  ...
  lite_node: {
    sections: [
      ...
      { title: "Risk Disclosure", body: "Node participation involves financial risk. The value of $NODAL can go up or down. Node rewards are not guaranteed. Only participate with funds you can afford to have committed long-term. NodalWaves Quest is an educational platform — this is not financial advice." },
    ],
    keyTakeaways: [
