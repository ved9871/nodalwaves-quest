        ...
        {activeTab === "referrals" && (
          <div className="space-y-6">
            ...
            <div className="card-nw p-6 border-glow-red text-center">
              ...
              <h3 className="font-display font-bold text-xl text-gradient-red mb-2">Join the NodalQuest Community</h3>
              <p className="text-muted-foreground text-sm mb-4">
                Connect with beta testers, ask questions, share your Quest progress, report bugs, and get official NodalQuest updates.
              </p>
              <a
            ...
            <div className="card-nw p-6 border-glow-gold text-center">
              ...
              <p className="text-muted-foreground text-sm mb-4">
                Join skill-based learning challenges, Web3 knowledge leagues, and community events as they go live during the NodalQuest beta.
              </p>
              <Button
                disabled
