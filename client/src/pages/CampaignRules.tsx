...
const RULES = [
  {
    ...
    content:
      "Participation in NodeWaves Quest does not guarantee any income, financial return, or monetary reward of any kind. NodeWaves Quest is an educational and community participation platform. Any reference to 'rewards' refers exclusively to in-platform XP, badges, ranks, and leaderboard recognition — not financial compensation.",
  },
  {
    id: 2,
    icon: XCircle,
    color: "#E53E3E",
    title: "No Guaranteed NWS or Token Reward",
    content:
      "XP points, badges, ranks, and quest completions earned on NodeWaves Quest do not represent, and cannot be converted into, NWS tokens or any other cryptocurrency or digital asset. No token allocation, airdrop, or on-chain reward is guaranteed to any user based on platform activity unless explicitly announced through official NodeWaves channels with published eligibility criteria.",
  },
  {
    id: 3,
    icon: CheckCircle2,
    ...
    content:
      "From time to time, NodeWaves may run official campaigns that include community rewards such as event access, merchandise, recognition, or other non-financial benefits. Any such campaign will be announced through official NodeWaves channels. Participation in the platform does not automatically qualify a user for any campaign reward. Each campaign will have its own published eligibility criteria, timeline, and selection process.",
  },
  {
    id: 4,
    icon: FileText,
  ...
  },
  {
    ...
    content:
      "Users found to be operating multiple accounts, using automated bots, exploiting platform bugs, or engaging in any form of fraudulent activity will be permanently disqualified from all current and future campaigns. NodeWaves reserves the right to investigate suspicious activity and take action including account suspension, XP reset, and removal from leaderboards. Disqualification decisions are final.",
  },
  {
    id: 6,
    icon: Shield,
  ...
  },
  {
    ...
    content:
      "NodeWaves Quest is designed as a learning and community participation platform. Its primary purpose is to educate users about the NodeWaves ecosystem — including NWS, staking, nodes, Node Vault, treasury mechanics, wallet safety, and scam protection. The platform's XP, badge, and rank systems exist to make learning engaging, not to create financial incentives. Users should engage with the platform to learn, not to speculate.",
  },
  {
    id: 8,
    icon: Zap,
    ...
    content:
      "NodeWaves reserves the right to modify, suspend, or cancel any campaign at any time. Changes will be communicated through official channels. Continued participation in the platform after a rule change constitutes acceptance of the updated terms. Users are encouraged to review campaign rules before each campaign period.",
  },
];
      ...
      <div className="container py-12 max-w-3xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground text-base max-w-xl mx-auto leading-relaxed">
            NodeWaves Quest is an educational platform. These rules govern how campaign-based community
        ...
        <div className="mt-10 card-nw p-6 border-glow-red">
          <h3 className="font-display font-bold text-base text-foreground mb-4 flex items-center gap-2">
            ...
            Summary: What NodeWaves Quest Is and Is Not
          </h3>
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-xs text-muted-foreground">
                {[
                  ...
                  "A place to learn about NWS, staking, nodes, and treasury",
                ].map((item) => (
            ...
            <div>
              ...
              <ul className="space-y-1.5 text-xs text-muted-foreground">
                {[
                  ...
                  "A promise of NWS or crypto rewards",
                ].map((item) => (
                  <li key={item} className="flex items-start gap-2">
        ...
        <div className="mt-8 text-center space-y-3">
          <p className="text-xs text-muted-foreground">
            Last updated: April 2026. These rules apply to all campaigns run on the NodeWaves Quest platform.
          </p>
